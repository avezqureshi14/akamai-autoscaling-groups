    ...
    <el-container class="h-screen">
        <el-header v-if="isLoggedIn" class="flex justify-between items-center border-b p-4 bg-white">
            ...
            <div class="flex flex-row items-center space-x-4">
                <el-select v-model="env" placeholder="Environment" size="large" style="width: 240px" @change="toggleEnvironment()" disabled>
        ...
        <el-container v-if="isLoggedIn">
            <el-aside class="bg-[#545c64]" :style="{ width: this.isCollapse ? '4rem' : '14rem' }">
                <el-menu :default-active="activeMenu" :collapse="isCollapse" :router="true" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b">
