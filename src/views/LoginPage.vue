<template>
    <div class="bg-gray-100 flex justify-center items-center w-full">
        <div class="flex flex-col bg-white p-8 rounded shadow-lg justify-center items-center w-1/4 space-y-4">
            ...
            <el-form :model="loginForm" label-position="top" class="w-full">
                ...
                <el-form-item label="Environment">
                    <el-select v-model="env" placeholder="Environment" @change="toggleEnvironment()">
                        <el-option label="Production" value="production" />
                        <el-option label="UAT" value="uat" />
                        <el-option label="Dev" value="dev" />
                    </el-select>
                </el-form-item>
                <el-button type="primary" @click="handleLogin" :loading="loading" class="w-full flex justify-center bg-indigo-600 border border-transparent rounded-md py-2 px-4 inline-flex items-center hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 text-white">
                    Login
                </el-button>
            </el-form>
        </div>
